...
<html>
	...
	<body>
		<div id="batas">
			...
			<div id="isi">
				<h2 style="color: #79878b;">KONTAK</h2>
				<h3>PEMBUAT WEB</h3>
				<img src="gambar/dode.JPG" width="150px" height="200px">
				<p style="font-size: 14px;">
					Nama : I Dewa Gede Rama Satya
					<br>
					Email : <a href="mailto: dewarama.satya@gmail.com">dewarama.satya@gmail.com</a>
					<br>
					WhatsApp : <a href="https://wa.me/6283114321772">+6283114321772</a>
					<br>
					Line : <a href="https://instagram.com/dewarama_satya">dewarama_satya</a>
				</p>
			</div>
			<div id="clear"></div>
			<div id="footer">
